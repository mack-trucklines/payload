...
var _STAR_current_component_STAR_26394 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_26394;
}});
...
var G__26398 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__26398) {
case "componentWillUnmount":
return ((function (G__26398){
return (function (){
var c = this;
...
var or__18113__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
while (G__26401__i < G__26401__a.length) {G__26401__a[G__26401__i] = arguments[G__26401__i + 0]; ++G__26401__i;}
  args = new cljs.core.IndexedSeq(G__26401__a,0);
} 
...
if(cljs.core.truth_((function (){var and__18101__auto__ = wrap;
...
var or__18113__auto__ = (function (){var and__18101__auto__ = cljs.core.fn_QMARK_.call(null,f);
if(and__18101__auto__){
var or__18113__auto__ = (f["displayName"]);
if(cljs.core.truth_(or__18113__auto__)){
return or__18113__auto__;
} else {
return (f["name"]);
...
var or__18113__auto____$1 = (function (){var and__18101__auto__ = (function (){var G__26412 = f;
if(G__26412){
var bit__18780__auto__ = (G__26412.cljs$lang$protocol_mask$partition1$ & (4096));
if((bit__18780__auto__) || (G__26412.cljs$core$INamed$)){
return true;
} else {
return false;
}
...
var render_fun = (function (){var or__18113__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__18113__auto__)){
return or__18113__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__18113__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__18113__auto__)){
return or__18113__auto__;
} else {
...
var G__26414 = o;
(G__26414[cljs.core.name.call(null,k)] = v);
...
var n = (function (){var G__26419 = reagent.impl.component._STAR_current_component_STAR_;
var G__26419__$1 = (((G__26419 == null))?null:(G__26419["cljsName"])());
return G__26419__$1;
})();
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__18867__auto__ = (function reagent$impl$component$shallow_obj_to_map_$_iter__26424(s__26425){
return (new cljs.core.LazySeq(null,(function (){
var s__26425__$1 = s__26425;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__26425__$1);
if(temp__4126__auto__){
var s__26425__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__26425__$2)){
var c__18865__auto__ = cljs.core.chunk_first.call(null,s__26425__$2);
var size__18866__auto__ = cljs.core.count.call(null,c__18865__auto__);
var b__26427 = cljs.core.chunk_buffer.call(null,size__18866__auto__);
if((function (){var i__26426 = (0);
while(true){
if((i__26426 < size__18866__auto__)){
var k = cljs.core._nth.call(null,c__18865__auto__,i__26426);
cljs.core.chunk_append.call(null,b__26427,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null));

var G__26428 = (i__26426 + (1));
i__26426 = G__26428;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26427),reagent$impl$component$shallow_obj_to_map_$_iter__26424.call(null,cljs.core.chunk_rest.call(null,s__26425__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__26427),null);
}
} else {
var k = cljs.core.first.call(null,s__26425__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null),reagent$impl$component$shallow_obj_to_map_$_iter__26424.call(null,cljs.core.rest.call(null,s__26425__$2)));
}
} else {
return null;
}
...
return iter__18867__auto__.call(null,cljs.core.js_keys.call(null,o));
})());
});
